@extends('layouts.app')
@section('titulo')
    REPORTE DE BOLETINES PREESCOLAR
@endsection
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">REPORTE DE BOLETINES DE PERIODO</h4>
        </div>
    </div>
</div>
<div class="col-md-12 col-lg-12 col-xl-12">
    <form method="POST" action="{{ route('boletines-preescolar') }}" target="_blanck">
    @csrf
    <div class="card m-b-30">
        <div class="card-body">
            ...
            <div class="row">
                ...
                @else
                <input type="hidden" value="{{ $sede }}" name="sede">
                @endif
