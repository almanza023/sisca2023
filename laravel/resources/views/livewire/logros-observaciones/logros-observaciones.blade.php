    ...
    <div class="row m-t-30">
        <div class="col-md-6 col-lg-6 col-xl-6">
            <div class="card m-b-30">
                <div class="card-body">
                    <h4 class="mt-0 header-title">DATOS LOGROS OBSERVACIONES FINALES</h4>
                   @if(count($sedes)>0)
                   <div class="row">
                    <div class="col-md-12">
        ...
        <div class="col-md-6 col-lg-6 col-xl-6">
            <div class="card m-b-30">
                <div class="card-body">
                    <h4 class="mt-0 header-title">LISTADO LOGROS OBSERVACIONES FINALES</h4>
                   @if(!empty($logros))
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <th colspan="3"><center>No existen datos</center></th>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
