...
class ShowDimensiones extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.dimensiones.show', compact('sedes','grados','asignaturas', 'periodos'));
    }
    ...
    public function buscar(){
        ...
        if(!empty($this->asignatura)){
            ...
            $calificaciones=Preescolar::calificacionesPeriodo($this->sede, $this->grado, $this->asignatura_id, $this->periodo);
