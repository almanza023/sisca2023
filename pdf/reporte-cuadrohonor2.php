...
if (isset($jornada) && isset($grado) && isset($periodo)  && isset($sede)) {
  ...
  $sqls="SELECT nombre from sedes where idsede='$sede'";
    ...
    $notaNo=0;
        ...
        $idest=$reg1['0'];
        $nom = $reg1['2'] . ' ' . $reg1['1'];       
         $sqlp2 = "SELECT nota, idasignatura from calificaciones where idestudiante='$idest'  and  idgrado='$grado' and idsede='$sede' and periodo ='$periodo' and orden>1 and orden<2  order by orden asc";            $resp2 = $mysqli->query($sqlp2);
...
//Otras Materias
            ...
            $a=0;
    $notaNo=0; 
$sqlp7 = "SELECT nota, idasignatura from calificaciones where idestudiante='$idest'  and  idgrado='$grado' and idsede='$sede' and periodo ='$periodo' and orden>=4.5   order by orden asc";
