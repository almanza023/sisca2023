...
$pr=round($promg, 2); 
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(198, 6, ' PROMEDIO DE PERIODO: '.$nprom.'        '.utf8_decode($des).'   '.$key, 1, 1, 'J', 1);
$pdf->SetFont('Arial', 'B', 8);
...
while ($i <= $num1) {
  while ($reg = $res->fetch_row()) {
    ...
    $pdf->SetFont('Arial', 'B', 8);
    $pdf->Cell(102, 6, ' ', 0, 0, 'J');
    $pdf->Cell(96, 4, 'PERIODOS  ', 1, 1, 'C', 1);
...
$pdf->SetX(112);
$pdf->Cell(16, 5, round($acp1, 1), 1, 0, 'J');
$pdf->SetX(128);            
$pdf->Cell(16, 5, round($ac, 1), 1, 0, 'J', 1);
$pdf->SetX(192);
$acdef=($acp1+$ac)/2;
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(16, 5, round($acdef,1), 1, 1, 'J',0);              
            //Lenguaje
$nt=0;
$c2=0;
$acl=0;
...
$pdf->SetX(112);
$pdf->Cell(16, 5, round($aclp1, 1), 1, 0, 'J');
$pdf->SetX(128);            
$pdf->Cell(16, 5, round($acl, 1), 1, 0, 'J',1);
$pdf->SetX(192);
$acdefl=($aclp1+$acl)/2;
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(16, 5, round($acdefl,1), 1, 1, 'J',0);  
            //CIENCIAS NATURALES
$c3=0;
$acn=0;
$acihn=0;                    
...
$pdf->SetX(112);
$pdf->Cell(16, 5, round($acnp1, 1), 1, 0, 'J');
$pdf->SetX(128);            
$pdf->Cell(16, 5, round($acn, 1), 1, 0, 'J',1);
$pdf->SetX(192);
$acdefn=($acnp1+$acn)/2;
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(16, 5, round($acdefn,1), 1, 1, 'J',0);  
         //CIENCIAS SOCIALES
$c4=0;
$acs=0;
$acihs=0;                    
...
$pdf->SetX(18);   
$pdf->SetFillColor(232, 232, 232);
$pdf->Cell(94, 5, "CIENCIAS SOCIALES".'    '.utf8_decode('100%'), 1, 0, 'J', 1);
$pdf->SetX(112);
$pdf->Cell(16, 5, round($acsp1, 1), 1, 0, 'J');
$pdf->SetX(128);            
$pdf->Cell(16, 5, round($acs, 1), 1, 0, 'J',1);
$pdf->SetX(192);
$acdefs=($acsp1+$acs)/2;
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(16, 5, round($acdefs,1), 1, 1, 'J',0);  
        //OTRAS MATERIAS
$act=0;
$c5=0;
$ac5=0;   
